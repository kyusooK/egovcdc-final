<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="createDeliveryDiagram" width="500">
                <CreateDeliveryCommand
                    @closeDialog="closeCreateDelivery"
	...
	async created() {
        ...
        methods: {
            ...
            async createDelivery(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['createdelivery'].href), params)
            ...
            openCreateDelivery() {
                this.createDeliveryDiagram = true;
            },
            closeCreateDelivery() {
